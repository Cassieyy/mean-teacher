...
class ImageRestorationModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        # define network
        self.net_g = define_network(deepcopy(opt['network_g'])) # opt['network_g']=HINet
    ...
    def optimize_parameters(self, current_iter):
        ...
        # preds = self.lq # for test the ori metrics
        print(self.lq.shape) # 1 3 256 256

        preds = self.net_g(self.lq)
        # print(type(preds))
        # print(preds[0].shape) # 1 3 256 256
    ...
    def test(self):
        ...
        with torch.no_grad():
            ...
            while i < n:
                ...
                if j >= n:
                    j = n
                # pred = self.lq[i:j, :, :, :] # for compute the old metrics
    ...
    def nondist_validation(self, dataloader, current_iter, tb_logger,
        ...
        for idx, val_data in enumerate(dataloader):
            print(val_data['lq'].shape) # [1, 3, 720, 1280]
            val_data['lq_path']
            img_name = osp.splitext(osp.basename(val_data['lq_path'][0]))[0]
            # if img_name[-1] != '9':
            #     continue

            print('val_data .. ', val_data['lq'].shape, val_data['gt'].shape)
