...
class HINet(nn.Module):
    def __init__(self, in_chn=3, wf=64, depth=5, relu_slope=0.2, hin_position_left=3, hin_position_right=4):
    ...
    def forward(self, x):
        ...
        out_2 = self.last(x2)
        out_2 = out_2 + image
        return [out_1, out_2] # out_1: the output of stage_1; out_2: final result
