...
def create_parser():
    ...
    parser.add_argument('--dataset', metavar='DATASET', default='GoPro',
    ...
    parser.add_argument('--labels', default="../datasets/GoPro/train/labeled.txt", type=str, metavar='FILE',
    ...
    parser.add_argument('--arch', '-a', metavar='ARCH', default='HINet',
    ...
    parser.add_argument('--labeled-batch-size', default=1, type=int,
    ...
    parser.add_argument('--consistency-type', default="mse", type=str, metavar='TYPE', # 实验证明mse要好
                        choices=['mse', 'kl'],
